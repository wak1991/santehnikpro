...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Апр 16 2019 г., 09:29
...
INSERT INTO `category` (`id`, `title`, `keywords`, `alias`, `description`, `parent_id`, `img`, `sort`, `text`) VALUES
(1, 'Монтаж труб', 'ggfgfd', 'montazh-trub', 'Проводим полный монтаж труб', 0, '0f8b24d6205d20265f38acdb74b39dd6.png', 0, '<p>fsad</p>'),
...
(4, 'Авто 4', '', 'avto-4', '', 0, '', 0, '<p>safdfdsafdsadsfa</p>');
...
(6, 'Трубы', '', '', 'truby', 4, 'Какой-то текст о трубах', '', 10, '0'),
