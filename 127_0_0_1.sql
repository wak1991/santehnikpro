...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Янв 05 2019 г., 11:52
...
INSERT INTO `constants` (`id`, `name`, `value`, `sort`) VALUES
...
INSERT INTO `pages` (`id`, `title`, `alias`, `parent_id`, `text`, `url`, `sort`) VALUES
